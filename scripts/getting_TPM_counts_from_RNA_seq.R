...
# Process --RNAseqGeneFolder argument
RNAseq_tpm_folder_args <- parseArgs(args, "--RNAseqGeneFolder")
if (length(RNAseq_tpm_folder_args) >= 1) {
  reading_gene_counts_folder(RNAseq_tpm_folder_args, outputFolder_args)
}

# Process --RNAseqSampleTpmCounts argument
RNAseq_tpm_args <- parseArgs(args, "--RNAseqGeneFiles")
if (length(RNAseq_tpm_args) > 0) {
  reading_gene_counts_files(RNAseq_tpm_args, outputFolder_args)
}
